...
public class CurrencyEditText extends androidx.appcompat.widget.AppCompatEditText {
    private static String prefix = "USD - $ ";
    ...
    public CurrencyEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.setHint(prefix + "(Required)");
        this.setFilters(new InputFilter[] { new InputFilter.LengthFilter(MAX_LENGTH) });
    }

    public void setCurrencyText(String p) {
        this.setText(prefix + p);
        currencyTextWatcher.afterTextChanged(this.getText());
    }
